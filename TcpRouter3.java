...
public class TcpRouter3
{
    ...
    private static final int listener_PORT = 1242;
    private static final int Router_Four_PORT = 1244;//was formerly 1244
            ...
            try{
                ...
                while (!message.equals("exit")){
                    ...
                    message = read_from_router_one.nextLine();
                        ...
                        //String str_from_four = read_from_router_four.nextLine();
